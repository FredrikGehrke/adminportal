(function($) {
  ...
  $(function() {
    ...
    if ($('#offlineProgress').length) { // OfflineProgress
    ...
    if ($('#onlineProgress').length) { // OnlineProgress
    ...
    if ($("#distribution-chart").length) { // distribution-chart
      var areaData = {
      ...
      var distributionChartPlugins = {
        beforeDraw: function(chart) {
          ...
          var text = updatesProcentageNumber + "%",
    ...
    if ($("#sale-report-chart").length) { // Sale report chart
